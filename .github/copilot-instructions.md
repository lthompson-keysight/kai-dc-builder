...
## Project overview (docs-only repo)
...
- To update downloadable artifacts, use Makefile targets that read aidc/env.latest (e.g., make pull, make url) before editing docs that reference them.
